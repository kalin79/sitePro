...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector(".loaderLogoContainer .logoContainer").innerHTML = LetraP + LetraR + LetraO;
    document.querySelector(".loaderLogoContainer .flechaContainer").innerHTML = FlechaLogo;

    // logoLetras.forEach((logo, index) => {
    gsap.to(".loaderLogoContainer .logoContainer svg", {
        opacity: .5,
        duration: .5,
        stagger: {
    ...
    gsap.to(".loaderLogoContainer .flechaContainer svg path", {
        duration: .5,
        fill: "#1E1E1E",
    ...
    gsap.to(".loaderLogoContainer .flechaContainer svg", {
        duration: .5,
        y: 5,
        repeat: 4,    // Repite indefinidamente
        yoyo: true,    // Vuelve al color original antes de repetir
    ...
    const texto1 = document.querySelector(".titularContainer .texto1");
    const textoOriginal1 = texto1.textContent;
    const letras1 = textoOriginal1.split("");

    const texto2 = document.querySelector(".titularContainer .texto2");
    const textoOriginal2 = texto2.textContent;
    const letras2 = textoOriginal2.split("");

    const palabras = document.querySelectorAll("#palabrasContainer h3");
    ...
    const spans1 = document.querySelectorAll(".titularContainer .texto1 span");
    const spans2 = document.querySelectorAll(".titularContainer .texto2 span");
    ...
    tlAnimacionBanner.to(".clip-shape.four", {
        duration: 1.5,
        ease: "power3.out",
        onUpdate: function () {
            let progress = 120 - this.progress() * 165; // Va de 124.03% a 24.03%

            document.querySelector('.clip-shape.four').style.clipPath = `
                polygon(
                65.96% ${progress}%, 
    ...
    tlAnimacionBanner.to(".clip-shape", {
        duration: 1,
        ease: "power3.out",
        onUpdate: function () {
            let progress = 130 - this.progress() * 140; // Va de 120% a 40%
            document.querySelector('.clip-shape').style.clipPath = `
                polygon(
                    66.13% ${progress - 20}%, 
                    72.64% ${progress - 13.2}%, 
                    72.76% ${progress - 6.2}%, 
    ...
    tlAnimacionBanner.to(".clip-shape.second", {
        duration: .75,
        ease: "power3.out",
        onUpdate: function () {
            let progress = 100 - this.progress() * 165; // Va de 124.03% a 24.03%

            document.querySelector('.clip-shape.second').style.clipPath = `
                polygon(
                    61.77% ${progress}%, 
                    77.24% ${progress + 19}%, 
    ...
    tlAnimacionBanner.to(".clip-shape.third", {
        duration: 1,
        ease: "power3.out",
        onUpdate: function () {
            let progress = 100 - this.progress() * 160; // Va de 124.03% a 24.03%

            document.querySelector('.clip-shape.third').style.clipPath = `
                polygon(
                65.96% ${progress}%, 
                75.87% ${progress + (39.14 - 25.7)}%, 
                75.97% ${progress + (54.39 - 25.7)}%, 
    ...
    tlAnimacionBanner.to(".clip-shape.five", {
        ...
        onUpdate: function () {
            ...
            document.querySelector('.clip-shape.five').style.clipPath = `
            polygon(
                61.77% ${size}%, 
                77.24% ${size + 19}%, 
                77.42% ${size + 36.69}%, 
        ...
        onComplete: function () {
            ...
            gsap.to(".clip-shape.five", {
                ...
                onUpdate: function () {
                    ...
                    document.querySelector('.clip-shape.five').style.backgroundPosition = `${initialPositionX}vw center`;
                    document.querySelector('.clip-shape.five').style.left = `${avance}vw`;
                ...
                `;
                    ...
                    document.querySelector('.clip-shape.five').style.backgroundPosition = `12vw center`;
    ...
    tlAnimacionBanner.to(".contenidoBannerMain .panelIzq", {
        duration: 3,
        ease: "power3.out",
        x: 0,
    }, 7)
    ...
    tlAnimacionBanner.fromTo(".flechaContainer .flechaImg",
        {
            y: "100vh",
        },
        {
    ...
    tlAnimacionBanner.fromTo(".flechaContainer .botellaImg",
        {
            y: "100vh",
        },
        {
